...
const TABS = ['Conflicts', 'Territories'];

export default function SidePanel() {
  const { state, dispatch } = useApp();
  const { selectedCountryId, focusedConflictId, conflicts: allStateConflicts, timelineYear, countries } = state;
...
function ConflictCard({ conflict, countries, selectedId, isFocused, onFocus }) {
